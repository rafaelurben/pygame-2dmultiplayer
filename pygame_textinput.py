...
class TextInput:
    ...
    def __init__(
        ...
        # Things cursor:
        self.cursor_surface = pygame.surface.Surface((int(self.font_size / 20 + 1), self.font_size))
    ...
    def update(self, events):
        for event in events:
            if event.type == pygame.constants.KEYDOWN:
                ...
                if event.key not in self.keyrepeat_counters:
                    if not event.key == pygame.constants.K_RETURN: # Filters out return key, others can be added as necessary
                ...
                elif event.key == pygame.constants.K_RETURN or event.key == pygame.constants.K_KP_ENTER:
                    return True
        ...
        for key in self.keyrepeat_counters:
            ...
            if self.keyrepeat_counters[key][0] >= self.keyrepeat_intial_interval_ms:
                ...
                pygame.event.post(pygame.event.Event(pygame.constants.KEYDOWN, key=event_key, unicode=event_unicode))
